...
<title>캘린더 관리</title>
<script src="/resources/calendar/js/jquery-3.1.1.min.js"></script>
<script src="/resources/calendar/js/bootstrap.min.js"></script>
<link rel="stylesheet" href="/resources/calendar/css/bootstrap.min.css">
<link rel="stylesheet" href="/resources/calendar/css/bootstrap-theme.min.css">
<script type="text/javascript" src='/resources/calendar/js/sweetalert.min.js?ver=1'></script>
<link rel="stylesheet" type="text/css" href='/resources/calendar/css/sweetalert.css?ver=1.2'>
<script type="text/javascript" src="/resources/calendar/js/calendarList.js"></script>
</head>
<body>
